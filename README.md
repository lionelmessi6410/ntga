...
## Overview
This is the repo for [Neural Tangent Generalization Attacks](http://www.cs.nthu.edu.tw/~shwu/pubs/shwu-icml-21.pdf), Chia-Hung Yuan and Shan-Hung Wu, In Proceedings of ICML 2021.
...
FNN(·) denotes an attack generated by NTGA from the FNN surrogate with a hyperparameter `t`. The *best* hyperparameter `t` is selected according to the empirical results. For the 2-class ImageNet, we choose `n01560419` and `n01910747` (bulbul v.s. jellyfish) from the original ImageNet dataset. Please refer to the [main paper](http://www.cs.nthu.edu.tw/~shwu/pubs/shwu-icml-21.pdf) and [supplementary materials](http://www.cs.nthu.edu.tw/~shwu/pubs/shwu-icml-21-sup.pdf) for more details.
- MNIST
	- FNN(best) = FNN(64)
	- CNN(best) = CNN(64)
- CIFAR-10
...
## Citation
If you find this code or dataset is helpful for your research, please cite our [ICML 2021 paper](http://www.cs.nthu.edu.tw/~shwu/pubs/shwu-icml-21.pdf).
